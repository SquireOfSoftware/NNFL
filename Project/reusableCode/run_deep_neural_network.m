...
classifications = loop_deep_neural_network(X, D, w, wBar, steps, bias, n);
disp(classifications);

function classifications = loop_deep_neural_network(X, D, w, wBar, steps, bias, n)
    classifications = zeros(3, steps);
    inputCounter = 1;
